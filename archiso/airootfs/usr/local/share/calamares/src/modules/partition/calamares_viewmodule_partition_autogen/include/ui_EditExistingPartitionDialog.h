...
public:
    ...
    void setupUi(QDialog *EditExistingPartitionDialog)
    {
        ...
        EditExistingPartitionDialog->resize(450, 615);
        ...
        formLayout->setWidget(7, QFormLayout::FieldRole, fileSystemLabelEdit);
        ...
        formLayout->setWidget(7, QFormLayout::LabelRole, fileSystemLabelLabel);
