...
public:
    ...
    void setupUi(QDialog *CreatePartitionDialog)
    {
        ...
        formLayout->setWidget(10, QFormLayout::FieldRole, labelMountPoint);
        ...
        formLayout->setWidget(11, QFormLayout::FieldRole, m_listFlags);

        verticalSpacer = new QSpacerItem(17, 13, QSizePolicy::Minimum, QSizePolicy::Expanding);

        formLayout->setItem(12, QFormLayout::LabelRole, verticalSpacer);
        ...
        filesystemLabelEdit->setMaximumSize(QSize(150, 16777215));
        filesystemLabelEdit->setMaxLength(16);

        formLayout->setWidget(9, QFormLayout::FieldRole, filesystemLabelEdit);
